...
try:
    ...
    TOKEN = os.environ('TOKEN_BOT_HLRLOOKUP','6833163649:AAEG-3VVBOLIqogcPRFS-hU5B-a3NhQ5rJM')  # BotFather's token
    API_KEY = os.environ.get['Tsetdua_bot']  # BSG World token
